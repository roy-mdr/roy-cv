...
>
	<div slot="preview">
		...
		<h2>{content[$appLang].shadowfx || content["en"].shadowfx}</h2>
		<img src={shadows_arrollo_iso} alt="Projected shadows isometric" />
		<img src={shadows_arrollo_top} alt="Projected shadows top view" />
	</div>
